 ...
 * @author Jefferson
 */
public class mostrarProgramas extends javax.swing.JInternalFrame {

    /**
     * Creates new form mostrarPrograma
     */
    public mostrarProgramas() {
        initComponents();
        this.getContentPane().setBackground(Color.decode("#FF0000"));
        //Mostramos los programas
        Programa programa = new Programa();
        programa.MostrarProgramas(tablaprogramas);
    }
